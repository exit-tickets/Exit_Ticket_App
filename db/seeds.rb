...
students = Student.create([
  ...
  {first_name: "Tracy", last_name: "Jordan", email: "tjordan@nbc.com", password: "password123", cohort_id: Cohort.find(6).id}, 
  {first_name: "Jenna", last_name: "Maroney", email: "jmaroney@nbc.com", password: "password123" , cohort_id: Cohort.find(6).id}, 
  {first_name: "Jenna", last_name: "Donaghy", email: "jmaroney@nbc.com", password: "password123", cohort_id: Cohort.find(6).id}, 
  {first_name: "Jenna", last_name: "Donaghy", email: "jmaroney@nbc.com", password: "password123", cohort_id: Cohort.find(6).id}, 
  {first_name: "Ricky", last_name: "Ricardo", email: "rricardo@email.com", password: "password123", cohort_id: Cohort.find(7).id}, 
  {first_name: "Lucy", last_name: "Ricardo", email: "lricardo@email.com", password: "password123", cohort_id: Cohort.find(7).id}, 
  {first_name: "Ethel", last_name: "Mertz", email: "emertz@email.com", password: "password123", cohort_id: Cohort.find(7).id}, 
  {first_name: "Fred", last_name: "Mertz", email: "fmertz@email.com", password: "password123", cohort_id: Cohort.find(7).id}, 
  {first_name: "Groucho", last_name: "Marx", email: "gmarx@email.com", password: "password123", cohort_id: Cohort.find(8).id}, 
  {first_name: "Chico", last_name: "Marx", email: "cmarx@email.com", password: "password123", cohort_id: Cohort.find(8).id}, 
  {first_name: "Harpo", last_name: "Marx", email: "hmarx@email.com", password: "password123", cohort_id: Cohort.find(8).id}, 
  {first_name: "Zeppo", last_name: "Marx", email: "zmarx@email.com", password: "password123", cohort_id: Cohort.find(8).id}, 
  {first_name: "Zach", last_name: "Morris", email: "zmorris@bayside.com", password: "password123", cohort_id: Cohort.find(9).id}, 
  {first_name: "Kelly", last_name: "Kapowski", email: "kkapowski@bayside.com", password: "password123", cohort_id: Cohort.find(9).id}, 
  {first_name: "A.C.", last_name: "Slater", email: "acslater@bayside.com", password: "password123", cohort_id: Cohort.find(9).id}, 
  {first_name: "Jessie", last_name: "Spano", email: "jspano@bayside.com", password: "password123", cohort_id: Cohort.find(10).id}, 
  {first_name: "Screech", last_name: "Samuels", email: "ssamuels@bayside.com", password: "password123", cohort_id: Cohort.find(10).id}, 
  {first_name: "Lisa", last_name: "Turtle", email: "lturtle@bayside.com", password: "password123", cohort_id: Cohort.find(10).id}, 
  {first_name: "Brenda", last_name: "Walsh", email: "brendawalsh@bhh.com", password: "password123", cohort_id: Cohort.find(11).id},
  {first_name: "Brandon", last_name: "Walsh", email: "brandonwalsh@bhh.com", password: "password123", cohort_id: Cohort.find(11).id},
  {first_name: "Dylan", last_name: "McKay", email: "dmckay@bhh.com", password: "password123", cohort_id: Cohort.find(11).id},
  {first_name: "Kelly", last_name: "Taylor", email: "ktaylor@bhh.com", password: "password123", cohort_id: Cohort.find(12).id},
  {first_name: "Steve", last_name: "Sanders", email: "ssanders@bhh.com", password: "password123", cohort_id: Cohort.find(12).id},
  {first_name: "Andrea", last_name: "Zuckerman", email: "azuckerman@bhh.com", password: "password123", cohort_id: Cohort.find(12).id},
  {first_name: "David", last_name: "Silver", email: "dsilver@bhh.com", password: "password123", cohort_id: Cohort.find(13).id},
  {first_name: "Donna", last_name: "Martin", email: "dsilver@bhh.com", password: "password123", cohort_id: Cohort.find(13).id},
  {first_name: "David", last_name: "Silver", email: "dsilver@bhh.com", password: "password123", cohort_id: Cohort.find(13).id},
  {first_name: "Jesse", last_name: "Vasquez", email: "dsilver@bhh.com", password: "password123", cohort_id: Cohort.find(13).id},
  {first_name: "David", last_name: "Silver", email: "dsilver@bhh.com", password: "password123", cohort_id: Cohort.find(13).id},
  {first_name: "Doc", last_name: "Walmart", email: "docwalmart@email.com", password: "password123", cohort_id: Cohort.find(14).id},
  {first_name: "Man", last_name: "Man", email: "manman@email.com", password: "password123", cohort_id: Cohort.find(14).id},
  {first_name: "A.", last_name: "Nubis", email: "nubicat@email.com", password: "password123", cohort_id: Cohort.find(14).id},
  ])
